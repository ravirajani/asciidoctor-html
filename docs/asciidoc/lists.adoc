...
This part describes some powerful new features for https://docs.asciidoctor.org/asciidoc/latest/lists/ordered/[ordered lists],
including automatic generation of reference text. It additionally demonstrates two useful
https://docs.asciidoctor.org/asciidoc/latest/attributes/document-attributes/[document attributes] `pagestyle=multi` and
`sectnums=true`.

NOTE: When using the `multi` pagestyle, all top-level sections need to have an ID.
