...
WARNING: This won't work for a cref:lists#sec-figlist[list of figures]. Put the `figlist` style
on an *unordered list* if you want an unnumbered list of figures.
